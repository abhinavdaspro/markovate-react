...
const SelectHire = () => {
    return (
        <div>
            <p className='text-black text-2xl font-bold'>Thank you for your interest in.</p>
                ...
                {data.map((val, i) => {
                    return <div key={i} className='border border-gray-light rounded px-10 py-5 flex'>
                        ...
                        <div className='pr-5 pt-1'>
                            <div className='h-[1.1rem] w-[1.1rem] rounded-full border border-black flex justify-center items-center cursor-pointer'>
                                <div className='bg-black rounded-full h-[0.6rem] w-[0.6rem]' />
                            </div>
                        </div>
                        <div>
            ...
            <div className='mt-10 border-t border-gray-light flex py-5 gap-x-5'>
                <button className='ml-auto bg-white text-black h-9 flex justify-center items-center border border-black rounded-3xl px-8 text-sm font-bold'>Back</button>
